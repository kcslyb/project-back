...
import cn.kcs.user.dao.TDictionaryDao;
import cn.kcs.user.entity.TDictionary;
import cn.kcs.user.entity.dto.DictionaryDto;
import cn.kcs.user.service.TDictionaryService;
...
public class TDictionaryServiceImpl implements TDictionaryService {
    ...
    public TDictionary insert(TDictionary tDictionary) {
        ...
        tDictionary.setDictionaryCreateTime(CustomDateUtil.stringToDate(CustomDateUtil
                .currentFormatDate(CustomDateUtil
                        .DATE_TO_STRING_DETAIL_PATTERN), CustomDateUtil
                .DATE_TO_STRING_DETAIL_PATTERN));

...
/**
 * @description: dom4j utill
 * @author: kcs
 * @create: 2019-03-08 10:02
 **/
public class DOM4Jutil {
    public static void main(String[] args) {
        List<Map<String, String>> list = readerXML("/Users/kcs/idea-workspace/myproject/base/common/src/main/resources/menu.xml");
